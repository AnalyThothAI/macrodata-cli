...
CATALOG_ENTRIES: list[SourceCatalogEntry] = [
    ...
    _cboe(
        ...
        "Cboe one-day S&P 500 option volatility index for same-day event-risk and ultra-short stress monitoring.",
    ),
    _cboe(
        "VIX9D",
    ...
    SourceCatalogEntry(
        series_key="nyfed:BGCR",
        name="Broad General Collateral Rate",
        provider="nyfed",
        dataset="BGCR",
        description="BGCR from NY Fed Markets API.",
        unit="percent",
        frequency="daily",
        latency_class="daily",
        requires_api_key=False,
        source_url="https://markets.newyorkfed.org/api/rates/secured/bgcr/search.json",
        license_note="NY Fed public data terms apply.",
    ),
    SourceCatalogEntry(
        series_key="nyfed:TGCR",
        name="Tri-Party General Collateral Rate",
        provider="nyfed",
        dataset="TGCR",
        description="TGCR from NY Fed Markets API.",
        unit="percent",
        frequency="daily",
        latency_class="daily",
        requires_api_key=False,
        source_url="https://markets.newyorkfed.org/api/rates/secured/tgcr/search.json",
        license_note="NY Fed public data terms apply.",
    ),
    SourceCatalogEntry(
        series_key="nyfed:SOFR_VOLUME",
        name="SOFR Underlying Volume",
        provider="nyfed",
        dataset="SOFR_VOLUME",
        description="Underlying transaction volume for SOFR from NY Fed Markets API.",
        unit="millions_usd",
        frequency="daily",
        latency_class="daily",
        requires_api_key=False,
    ...
    SourceCatalogEntry(
        series_key="nyfed:BGCR_VOLUME",
        name="BGCR Underlying Volume",
        provider="nyfed",
        dataset="BGCR_VOLUME",
        description="Underlying transaction volume for BGCR from NY Fed Markets API.",
        unit="millions_usd",
        frequency="daily",
        latency_class="daily",
        requires_api_key=False,
    ...
    SourceCatalogEntry(
        series_key="nyfed:TGCR_VOLUME",
        name="TGCR Underlying Volume",
        provider="nyfed",
        dataset="TGCR_VOLUME",
        description="Underlying transaction volume for TGCR from NY Fed Markets API.",
        unit="millions_usd",
        frequency="daily",
        latency_class="daily",
        requires_api_key=False,
    ...
    SourceCatalogEntry(
        series_key="nyfed:EFFR",
        name="Effective Federal Funds Rate",
        provider="nyfed",
        dataset="EFFR",
        description="Effective Federal Funds Rate from NY Fed Markets API.",
        unit="percent",
        frequency="daily",
        latency_class="daily",
        requires_api_key=False,
        source_url="https://markets.newyorkfed.org/api/rates/unsecured/effr/search.json",
        license_note="NY Fed public data terms apply.",
    ),
    SourceCatalogEntry(
        series_key="nyfed:OBFR",
        name="Overnight Bank Funding Rate",
        provider="nyfed",
        dataset="OBFR",
        description="Overnight Bank Funding Rate from NY Fed Markets API.",
        unit="percent",
        frequency="daily",
        latency_class="daily",
        requires_api_key=False,
        source_url="https://markets.newyorkfed.org/api/rates/unsecured/obfr/search.json",
        license_note="NY Fed public data terms apply.",
    ),
    SourceCatalogEntry(
        series_key="nyfed:EFFR_VOLUME",
        name="EFFR Underlying Volume",
        provider="nyfed",
        dataset="EFFR_VOLUME",
        description="Underlying transaction volume for EFFR from NY Fed Markets API.",
        unit="millions_usd",
        frequency="daily",
        latency_class="daily",
        requires_api_key=False,
    ...
    SourceCatalogEntry(
        series_key="nyfed:OBFR_VOLUME",
        name="OBFR Underlying Volume",
        provider="nyfed",
        dataset="OBFR_VOLUME",
        description="Underlying transaction volume for OBFR from NY Fed Markets API.",
        unit="millions_usd",
        frequency="daily",
        latency_class="daily",
        requires_api_key=False,
